...
.cmf__hero-sub { margin: 0; color: var(--color-gray-600, #A3A3A3); font-size: 15px; line-height: 1.5; }
...
.cmf__progress-caption { margin: 8px 0 0; font-size: 13px; color: var(--color-gray-600, #A3A3A3); }
...
.cmf__hint { margin: 0; color: var(--color-gray-600, #A3A3A3); font-size: 14px; line-height: 1.5; }

/* selectable cards */
.cmf__card {
  display: flex; align-items: center; gap: var(--space-m, 12px); width: 100%;
  padding: var(--space-m, 12px); text-align: left;
  background: var(--color-surface-panel, #1E1E1E); border: 2px solid transparent; border-radius: 14px;
...
.cmf__card-desc { font-size: 13px; color: var(--color-gray-600, #A3A3A3); line-height: 1.4; }

/* fields */
.cmf__field { display: flex; flex-direction: column; gap: 6px; min-width: 0; }
.cmf__field-label { font-size: 14px; color: var(--color-field-label, rgba(255,255,255,0.85)); }
.cmf__input {
  width: 100%; max-width: 100%; box-sizing: border-box; padding: 12px 14px; font: inherit; color: var(--color-on-surface, #FFFFFF);
  background: var(--color-surface-panel, #1E1E1E); border: 1px solid var(--color-on-surface-outline, rgba(255,255,255,0.15)); border-radius: 10px;
  transition: border-color var(--dur-short) var(--ease-out);
}
.cmf__input:focus { outline: none; border-color: var(--color-brand); }
.cmf__input[readonly] { color: var(--color-input-readonly, #DDD); }
.cmf__input::placeholder { color: var(--color-gray-600, #A3A3A3); }

/* rules */
.cmf__rule { display: flex; flex-direction: column; gap: 8px; }
.cmf__rule--row { flex-direction: row; align-items: center; justify-content: space-between; text-align: left; background: var(--color-surface-panel, #1E1E1E); border: none; border-radius: 12px; padding: 14px; cursor: pointer; color: var(--color-on-surface, #FFFFFF); width: 100%; }
...
.cmf__stepper {
  ...
  background: var(--color-surface-panel, #1E1E1E); border-radius: 999px; padding: 4px;
}
...
.cmf__segmented button {
  ...
  background: var(--color-surface-panel, #1E1E1E); color: var(--color-gray-600, #A3A3A3); font-weight: 600; cursor: pointer;
}
.cmf__segmented button.is-on { border-color: var(--color-brand); color: var(--color-on-surface, #FFFFFF); }

/* review */
.cmf__summary { list-style: none; margin: 0; padding: 0; display: flex; flex-direction: column; gap: 2px; background: var(--color-surface-panel, #1E1E1E); border-radius: 12px; overflow: hidden; }
...
.cmf__summary span { color: var(--color-gray-600, #A3A3A3); font-size: 14px; }
...
.cmf__btn--outline { background: transparent; color: var(--color-on-surface, #FFFFFF); border: 1.5px solid var(--color-gray-600, #A3A3A3); }
